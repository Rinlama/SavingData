...
public class MyFragment extends Fragment {
    ...
    public void onPause() {
        ...
        editor.putInt(getString(R.string.level),6);
        editor.commit();

        SharedPreferences.Editor stringeditor= sharedPref.edit();
        editor.putString(getString(R.string.preference_file_name),"Bob");
        editor.commit();
    ...
    public void onResume() {
        super.onResume();
        SharedPreferences sharePref= getActivity().getSharedPreferences(getString(R.string.preference_file_name),Context.MODE_PRIVATE);
